...
const Footer = () => {
  return (
    <footer className="w-full py-12 px-4 mx-auto font-semibold pt-8 bg-gray-900">
      ...
      <div className="container mx-auto flex flex-col lg:flex-row justify-between space-y-8 lg:space-y-0 py-10">
        ...
        <div className="lg:w-2/3 grid gap-8 sm:grid-cols-2 lg:grid-cols-3 md:pl-16 justify-between">
          {/* Navlinks */}
          <div>
            <h3 className="uppercase text-gray-50 mb-2">Navigation</h3>
            <ul className="space-y-2">
              <li>
                <Link
                  to="/skill"
                  className="text-gray-300 transition-colors duration-200 hover:text-[#0dccf2]"
                >
                  Skills
                </Link>
              </li>
          ...
          {/* Developers */}
          <div>
            <h3 className="uppercase text-gray-50 mb-2">Developers</h3>
            <ul className="space-y-2">
              <li>
                <Link
                  to="/"
          ...
          {/* Social Media */}
          <div>
            <h3 className="uppercase text-gray-50 mb-2">Follow Us</h3>
            <div className="flex space-x-4">
              ...
              >
                <svg
                  ...
                  className="w-6 h-6 text-[#0dccf2] transition-transform duration-300 hover:scale-110"
                  viewBox="0 0 320 512"
                >
                  <path
                    fill="currentColor"
